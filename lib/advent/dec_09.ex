defmodule Advent.Dec09 do
  ...
  def total_garbage(input \\ @default_input) do
    input
    |> String.trim
    |> tokenize
    |> sum_garbage
  ...
  defp tokenize(type \\ :list, input, acc \\ [])
  defp tokenize(:list, "", acc), do: acc |> Enum.reverse
  ...
  defp score(["}" | rest], d, a), do: score(rest, d - 1, a)
  defp score([_ | rest], d, a), do: score(rest, d, a)
  defp score([], 1, a), do: a
